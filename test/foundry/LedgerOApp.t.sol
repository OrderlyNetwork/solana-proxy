...
import { MessagingFee, Origin } from "../../contracts/layerzerolabs/lz-evm-oapp-v2/contracts/oapp/OAppUpgradeable.sol";
// OZ imports
...
contract LedgerOAppTest is TestHelperOz5 {
    ...
    function test_send_message() public {
        ...
        assertEq(afterBalance + msgFee.nativeFee, beforeBalance);
    }
