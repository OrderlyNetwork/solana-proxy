export type Endpoint = {
            ...
            accounts: [
                {
                    ...
                    isMut: true
                    isSigner: true
                    docs: ['only the delegate can initialize the nonce accounts']
                },
                {
                    name: 'oappRegistry'
                    isMut: false
            ...
            accounts: [
                {
                    ...
                    isMut: true
                    isSigner: true
                    docs: ['only the delegate can initialize the send_library_config']
                },
                {
                    name: 'oappRegistry'
                    isMut: false
            ...
            accounts: [
                {
                    ...
                    isMut: false
                    isSigner: true
                    docs: ['The PDA of the OApp or delegate']
                },
                {
                    name: 'oappRegistry'
                    isMut: false
            ...
            accounts: [
                {
                    ...
                    isMut: false
                    isSigner: true
                    docs: ['only the delegate can initialize the config accounts']
                },
                {
                    name: 'oappRegistry'
                    isMut: false
                ...
                },
                {
                    ...
                    isMut: false
                    isSigner: false
                    docs: ['The PDA signer to the message lib when the endpoint calls the message lib program.']
                },
                {
                    name: 'messageLib'
                    isMut: false
                    isSigner: false
                    docs: ['the pda of the message_lib_program']
                },
                {
        ...
        },
        {
            ...
            accounts: [
                ...
                },
                {
                    ...
                    isMut: false
                    isSigner: false
                    docs: ['The PDA signer to the send library when the endpoint calls the send library.']
                },
                {
                    name: 'endpoint'
                    isMut: false
            ...
            accounts: [
                {
                    ...
                    isMut: false
                    isSigner: true
                    docs: ['The PDA of the receive library.']
                },
                {
                    name: 'receiveLibraryConfig'
                    isMut: false
        ...
        },
        {
            ...
            accounts: [
                ...
                },
                {
                    ...
                    isMut: true
                    isSigner: false
                    docs: ['close the account and return the lamports to endpoint settings account']
                },
                {
                    name: 'endpoint'
                    isMut: true
    ...
    accounts: [
        ...
        {
            name: 'sendLibraryConfig'
            docs: ['the reason for not using Option::None to indicate default is to respect the spec on evm']
            type: {
                kind: 'struct'
                fields: [
                    {
