export type Oft = {
    ...
    accounts: [
        {
            name: 'lzReceiveTypesAccounts'
            docs: ['LzReceiveTypesAccounts includes accounts that are used in the LzReceiveTypes', 'instruction.']
            type: {
                kind: 'struct'
                fields: [
                    {
    ...
    types: [
        ...
        {
            name: 'LzAccount'
            docs: ['same to anchor_lang::prelude::AccountMeta']
            type: {
                kind: 'struct'
                fields: [
                    {
